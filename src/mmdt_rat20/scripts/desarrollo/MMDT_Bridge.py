...
# Esta es una version basica, incluye el robot y una esfera indicadora
...
def talker():
    ...
    rospy.Subscriber("/esfera_position", Float64MultiArray, callbackEsfera)
