...
if("TRUE" STREQUAL "TRUE")
  set(mmdt_rat20_SOURCE_PREFIX /mnt/c/TunnelWSL/MMDT/src/mmdt_rat20)
  set(mmdt_rat20_DEVEL_PREFIX /mnt/c/TunnelWSL/MMDT/devel)
  ...
  set(mmdt_rat20_INSTALL_PREFIX /mnt/c/TunnelWSL/MMDT/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mmdt_rat20' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/c/TunnelWSL/MMDT/src/mmdt_rat20/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/c/TunnelWSL/MMDT/devel/lib;/mnt/c/TunnelWSL/MMDT/devel/lib;/opt/ros/melodic/lib)
